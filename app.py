...
# # S3 File Locations
# image_bucket = 'inference-3'
# image_key = '2024/10/23/shift_2/images/59BIE_2024_10_23_15_15_15.jpg'

# csv_bucket = 'inference-3'
# csv_key = '2024/10/23/shift_2/csv/01-03-2025-2761-report.csv'
...
# # Streamlit App
# st.title("S3 Image and Report Viewer")

# # Display Image
# st.header("Image Preview")
# try:
#     image = fetch_image(image_bucket, image_key)
#     st.image(image, caption="Fetched from S3", use_column_width=True)
# except Exception as e:
#     st.error(f"Error fetching image: {e}")

# # Display CSV Report
# st.header("CSV Report")
# try:
#     csv_data = fetch_csv(csv_bucket, csv_key)
